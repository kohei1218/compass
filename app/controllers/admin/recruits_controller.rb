class Admin::RecruitsController < ApplicationController
  ...
  # GET /admin/recruits
  # GET /admin/recruits.json
  def index
    @recruits = Recruit.all
  end

  # GET /admin/recruits/1
  # GET /admin/recruits/1.json
  def show
  end

  # GET /admin/recruits/new
  def new
    @recruit = Recruit.new
  end

  # GET /admin/recruits/1/edit
  def edit
  end

  # POST /admin/recruits
  # POST /admin/recruits.json
  def create
    @recruit = Recruit.new(admin_recruit_params)
  ...
  # PATCH/PUT /admin/recruits/1
  # PATCH/PUT /admin/recruits/1.json
  def update
    respond_to do |format|
      if @recruit.update(admin_recruit_params)
  ...
  # DELETE /admin/recruits/1
  # DELETE /admin/recruits/1.json
  def destroy
    @recruit.destroy
    respond_to do |format|
